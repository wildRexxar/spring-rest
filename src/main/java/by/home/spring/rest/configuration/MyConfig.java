...
@Configuration
@ComponentScan(basePackages = "by.home.spring.rest")
@EnableWebMvc
...
public class MyConfig {
    ...
    public DataSource dataSource() {
        ...
        try {
            ...
            dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/my_db?userSSL=false&serverTimezone=UTC");
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("by.home.spring.rest.entity");
